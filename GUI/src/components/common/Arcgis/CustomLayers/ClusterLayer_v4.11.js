...
export default async function ClusterLayer() {
  ...
  var FlareClusterLayer = /** @class */ (function(_super) {
    ...
    function FlareClusterLayer(options) {
      ...
      _this.labelField = options.labelField; // new: feature label
      ...
      _this.singleRenderer = options.singleRenderer; // feature layer render
      ...
      _this.singleTextSymbol =      // new: feature label -- text symbol
        options.singleTextSymbol ||
        new TextSymbol({
    ...
    FlareClusterLayer.prototype._createSingle = function(obj) {
      ...
      if (this.singleRenderer) {
        ...
        var number = obj[this.labelField];
        graphic.symbol = symbol;

        textGraphic = new Graphic({
          geometry: point,
          attributes: obj,
          symbol: this.singleTextSymbol
        });

        textGraphic.symbol.text = number > 1 && number <= 99 ? String(number) : '99+';
        textGraphic = textGraphic.clone();
      ...
      if (textGraphic && obj[this.labelField] > 1) {
    ...
    FlareClusterLayer.prototype._createSurface = function() {
      ...
      if (this._is2d) {
        surfaceParentElement =
          this._activeView.container.parentElement || this._activeView.container.parentNode;
      } else {
        surfaceParentElement =
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this._createClonedElementFromGraphic(this._activeCluster.clusterGraphic)
              ];
            case 1:
              ...
              return [
                4 /*yield*/,
                this._createClonedElementFromGraphic(this._activeCluster.textGraphic)
              ];
            case 2:
    ...
    FlareClusterLayer.prototype._createClonedElementFromGraphic = function(graphic) {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, symbolUtils.renderPreviewHTML(graphic.symbol)];
            case 1:
              element = _a.sent();
    ...
    FlareClusterLayer.prototype._initFlares = function() {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              if (!this._activeCluster || !this.displayFlares) return [2 /*return*/];
