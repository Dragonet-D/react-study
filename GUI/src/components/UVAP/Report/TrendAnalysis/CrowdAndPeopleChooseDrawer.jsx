...
function CrowdAndPeopleChooseDrawer(props) {
  const {
    open,
    onClose,
    getChannelList,
  ...
  function handleDeviceRowSelection(ids, items) {
    ...
    console.log(newMultipleDeivceItems);
...
CrowdAndPeopleChooseDrawer.defaultProps = {
  open: false,
  onClose: () => {},
  channelList: {},
  getChannelList: () => {},
...
CrowdAndPeopleChooseDrawer.propTypes = {
  open: PropTypes.bool,
...
export default CrowdAndPeopleChooseDrawer;
