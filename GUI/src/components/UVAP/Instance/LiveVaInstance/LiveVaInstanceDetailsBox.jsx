...
function LiveVaInstanceDetailsBox(props) {
...
LiveVaInstanceDetailsBox.defaultProps = {
  engineList: [],
  getEngineList: () => {},
  dispatchInstanceInfo: () => {},
  dispatchSourceDetails: () => {},
...
LiveVaInstanceDetailsBox.propTypes = {
...
export default LiveVaInstanceDetailsBox;
