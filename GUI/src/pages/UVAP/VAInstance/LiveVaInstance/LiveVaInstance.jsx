...
function LiveVaInstance(props) {
  const classes = useStyles();
  const { dispatch, global, LiveVaInstance } = props;
  const { userId, commonWebsocketData } = global;
  const { instanceData, namespace, instanceDetails, statusList } = LiveVaInstance;
  ...
  function handleActions(target, data) {
    switch (target) {
      ...
      case 'restart':
        ...
        setCurrentData(data);
        setConfirmTitle(I18n.t('vap.confirm.instance.live.restartTitle'));
        setConfirmMsg(I18n.t('vap.confirm.instance.live.restartMsg'));
        setConfirmDialog(true);
        break;
      case 'deactivate':
        setConfirmType('deactivate');
        setCurrentData(data);
        setConfirmTitle(I18n.t('vap.confirm.instance.live.deactivateTitle'));
        setConfirmMsg(I18n.t('vap.confirm.instance.live.deactivateMsg'));
        setConfirmDialog(true);
        break;
      case 'activate':
        setConfirmType('activate');
        setCurrentData(data);
        setConfirmTitle(I18n.t('vap.confirm.instance.live.activateTitle'));
        setConfirmMsg(I18n.t('vap.confirm.instance.live.activateMsg'));
        setConfirmDialog(true);
        break;
      case 'delete':
        setConfirmType('delete');
        setCurrentData(data);
        setConfirmTitle(I18n.t('vap.confirm.instance.live.deleteTitle'));
        setConfirmMsg(I18n.t('vap.confirm.instance.live.deleteMsg'));
        setConfirmDialog(true);
        break;
      default:
        break;
  ...
  function deactivateInstance(obj = {}) {
    dispatch({
      ...
      dataUpdatedHandle(res, I18n.t('vap.confirm.instance.live.deactivateTitle'), () => {
        getInstanceList();
      });
    });
  }
  function activateInstance(obj = {}) {
    dispatch({
      ...
      dataUpdatedHandle(res, I18n.t('vap.confirm.instance.live.activateTitle'), () => {
        getInstanceList();
      });
    });
  }
  function restartInstance(obj = {}) {
    dispatch({
      ...
      dataUpdatedHandle(res, I18n.t('vap.confirm.instance.live.restartTitle'), () => {
        getInstanceList();
      });
    });
  }
  function deleteInstance(obj = {}) {
    dispatch({
      ...
      dataUpdatedHandle(res, I18n.t('vap.confirm.instance.live.deleteTitle'), () => {
        getInstanceList();
      });
    });
  }
  ...
  function updateInstance(obj = {}) {
    dispatch({
      ...
      dataUpdatedHandle(res, I18n.t('vap.dialog.instance.live.updateTitle'), () => {
        setEditDialogStatus(false);
        getInstanceList();
      });
    });
